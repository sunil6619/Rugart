...
public class TC_256_Check_able_to_remove_product_from_cart extends Base{
	...
	public  TC_256_Check_able_to_remove_product_from_cart() {
	...
	public void click_remove_item() throws InterruptedException {
		Thread.sleep(1000);
		pagedown();
		widthft.sendKeys("4");
		lgthft.sendKeys("6");
	...
	public void check_remove_product_cart() throws InterruptedException, AWTException {
		TC_256_Check_able_to_remove_product_from_cart ob = new TC_256_Check_able_to_remove_product_from_cart();
		ob.clickoncollection();
		ob.click_remove_item();
		Log.info("Checking remove product from Cart");
	}
}
