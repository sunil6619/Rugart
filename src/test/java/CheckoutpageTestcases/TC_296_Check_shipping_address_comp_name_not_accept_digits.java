...
public class TC_296_Check_shipping_address_comp_name_not_accept_digits extends Base{
	...
	public TC_296_Check_shipping_address_comp_name_not_accept_digits  () {
	...
	public void check_shipping_add_company_name_not_accept_digits_verify_msg() throws InterruptedException, AWTException {
		TC_296_Check_shipping_address_comp_name_not_accept_digits  ob = new TC_296_Check_shipping_address_comp_name_not_accept_digits ();
		ob.clickoncollection();
		ob.entercompanyname();
		Log.info("Checking shipping address comp name not accept digits");
	}
