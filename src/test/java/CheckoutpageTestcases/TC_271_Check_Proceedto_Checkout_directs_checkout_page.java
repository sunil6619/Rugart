...
public class TC_271_Check_Proceedto_Checkout_directs_checkout_page extends Base{
	...
	public TC_271_Check_Proceedto_Checkout_directs_checkout_page () {
	...
	public void click_proceed_checkout() throws InterruptedException {
		...
		checkoutpopup.click();
		Thread.sleep(1000);
		String expectdpage=checkoutpage.getText();
		Assert.assertEquals("CHECKOUT", expectdpage);
	...
	public void check_proceed_checkout_displays() throws InterruptedException, AWTException {
		TC_271_Check_Proceedto_Checkout_directs_checkout_page ob = new TC_271_Check_Proceedto_Checkout_directs_checkout_page();
		ob.clickoncollection();
		ob.click_proceed_checkout();
		Log.info("Checking proceed to checkout directs to checkout page");
	}
