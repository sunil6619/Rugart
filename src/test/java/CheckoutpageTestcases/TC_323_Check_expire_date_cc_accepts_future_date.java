...
public class TC_323_Check_expire_date_cc_accepts_future_date extends Base{
	...
	public  TC_323_Check_expire_date_cc_accepts_future_date() {
	...
	public void entercreditcard() throws InterruptedException {
		...
		expiredateinput.sendKeys("10/25");
		String expected=expiredateinput.getAttribute("value");
	    Assert.assertEquals("10 / 25", expected);

	}
	
	@Test

	public void check_creditcard_exp_date_accept_future_date() throws InterruptedException, AWTException {
		TC_323_Check_expire_date_cc_accepts_future_date ob = new TC_323_Check_expire_date_cc_accepts_future_date();
		ob.clickoncollection();
		ob.entercreditcard();
		Log.info("Checking credit card expire date accept future date");
	}
