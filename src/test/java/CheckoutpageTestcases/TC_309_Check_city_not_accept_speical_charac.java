...
public class TC_309_Check_city_not_accept_speical_charac extends Base{
	...
	public TC_309_Check_city_not_accept_speical_charac() {
	...
	public void check_city_not_accept_speical_chara() throws InterruptedException, AWTException {
		TC_309_Check_city_not_accept_speical_charac ob = new  TC_309_Check_city_not_accept_speical_charac();
		ob.clickoncollection();
		ob.entercity();
		Log.info("Checking city not accept special charac,veriy error msg");
	}
