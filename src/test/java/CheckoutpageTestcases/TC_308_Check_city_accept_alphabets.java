...
public class TC_308_Check_city_accept_alphabets extends Base{
	...
	public TC_308_Check_city_accept_alphabets() {
	...
	public void entercity() throws InterruptedException {
		...
		String expected=city.getAttribute("value");
	...
	public void check_city_accept_alphabets() throws InterruptedException, AWTException {
		TC_308_Check_city_accept_alphabets ob = new  TC_308_Check_city_accept_alphabets();
		ob.clickoncollection();
		ob.entercity();
		Log.info("Checking city accepts alphabets");
	}
