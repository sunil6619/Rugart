...
public class TC_301_Check_street_address_displays_msg_left_blank extends Base{
	...
	TC_301_Check_street_address_displays_msg_left_blank () {
	...
	public void enterstreetaddress() throws InterruptedException {
		...
		Assert.assertEquals("The \"Address\" field is required", expected);
	}
	

	@Test

	public void check_street_add_displays_msg_left_blank() throws InterruptedException, AWTException {
		TC_301_Check_street_address_displays_msg_left_blank ob = new TC_301_Check_street_address_displays_msg_left_blank ();
		ob.clickoncollection();
		ob.enterstreetaddress();
		Log.info("Checking street address display error msg when left blank");
	}
