...
public class TC_299_Check_shipping_address_comp_name_accept_alphabets extends Base{
	...
	public TC_299_Check_shipping_address_comp_name_accept_alphabets () {
	...
	public void entercompanyname() throws InterruptedException {
		...
		newaddress.click();
		Thread.sleep(2000);
		companyname.sendKeys("Rugartisan");
		Thread.sleep(1000);
		placeorder.click();
	...
	public void check_shipping_add_company_name_accept_alphabets() throws InterruptedException, AWTException {
		TC_299_Check_shipping_address_comp_name_accept_alphabets ob = new TC_299_Check_shipping_address_comp_name_accept_alphabets ();
		ob.clickoncollection();
		ob.entercompanyname();
		Log.info("Checking shipping address comp name accept alphabet charac");
	}
