...
public class TC_293_Check_shipping_address_Country_dropdown extends Base{
	...
	@FindBy(xpath = "//select[@id=\"shipping_country\"]/child::option")
	private List<WebElement> countrylist; 
	
	public TC_293_Check_shipping_address_Country_dropdown() {
	...
	public void entercountry() throws InterruptedException {
		...
		String expected=country.getAttribute("value");
		Assert.assertEquals("United Kingdom", expected);
		countrylist.listIterator();
		int numb=countrylist.size();
		System.out.println(numb);

	}
	@Test

	public void check_country_dropdown_functionality() throws InterruptedException, AWTException {
		TC_293_Check_shipping_address_Country_dropdown ob = new TC_293_Check_shipping_address_Country_dropdown();
		ob.clickoncollection();
		ob.entercountry();
		Log.info("Checking shipping address country dropdown");
	}
