...
public class TC_312_Check_city_left_blank_verify_error_msg extends Base{
	...
	public TC_312_Check_city_left_blank_verify_error_msg () {
	...
	public void entercity() throws InterruptedException {
		...
		Assert.assertEquals("The \"City\" field is required",expected);
		
	}
	
	@Test

	public void check_city_left_blank_verify_msg() throws InterruptedException, AWTException {
		TC_312_Check_city_left_blank_verify_error_msg ob = new TC_312_Check_city_left_blank_verify_error_msg();
		ob.clickoncollection();
		ob.entercity();
		Log.info("Checking city left blank,veriy error msg");
	}
