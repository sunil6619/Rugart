...
public class TC_303_Check_street_address_accept_special_charac extends Base{
	...
	TC_303_Check_street_address_accept_special_charac() {
	...
	public void check_street_address_accept_special_charac()throws InterruptedException, AWTException {
		TC_303_Check_street_address_accept_special_charac ob = new TC_303_Check_street_address_accept_special_charac ();
		ob.clickoncollection();
		ob.enterstreetaddress();
		Log.info("Checking street address accept special charac");
	}
