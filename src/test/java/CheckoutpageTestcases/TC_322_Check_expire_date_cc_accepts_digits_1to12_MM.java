...
public class TC_322_Check_expire_date_cc_accepts_digits_1to12_MM extends Base {
	...
	public  TC_322_Check_expire_date_cc_accepts_digits_1to12_MM() {
	...
	public void check_creditcard_exp_date_accept_1to12_MM() throws InterruptedException, AWTException {
		TC_322_Check_expire_date_cc_accepts_digits_1to12_MM ob = new TC_322_Check_expire_date_cc_accepts_digits_1to12_MM();
		ob.clickoncollection();
		ob.entercreditcard();
		Log.info("Checking credit card expire date accept 1-12 in MM");
	}
