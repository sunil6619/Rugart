...
public class TC_281_Check_shipping_address_lastname_accept_alphabets extends Base{
	...
	public TC_281_Check_shipping_address_lastname_accept_alphabets () {
	...
	public void enterlastname() throws InterruptedException {
		...
		Assert.assertEquals("Suri", expected);
		
	}
	@Test

	public void check_last_name_accept_alphabets() throws InterruptedException, AWTException {
		TC_281_Check_shipping_address_lastname_accept_alphabets ob = new TC_281_Check_shipping_address_lastname_accept_alphabets();
		ob.clickoncollection();
		ob.enterlastname();
		Log.info("Checking shipping address last name accept alphabets");
	}
