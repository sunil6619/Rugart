...
public class TC_310_Check_city_not_accept_digits extends Base{
	...
	public TC_310_Check_city_not_accept_digits() {
	...
	public void check_city_not_accept_digits() throws InterruptedException, AWTException {
		TC_310_Check_city_not_accept_digits ob = new TC_310_Check_city_not_accept_digits();
		ob.clickoncollection();
		ob.entercity();
		Log.info("Checking city not accept digits,veriy error msg");
	}
