...
public class TC_327_Check_checkout_page_displays_handling_charge extends Base{
	...
	@FindBy(xpath = "//td[contains(text(),'Handling')]")
	private WebElement handlingcharge;
	
	public  TC_327_Check_checkout_page_displays_handling_charge() {
	...
	public void displayhandlingcharge() throws InterruptedException {
		...
		topcheckout.click();
		Thread.sleep(3000);
		String expected=handlingcharge.getText();
		
		Assert.assertEquals("Handling Charge",expected);
	...
	public void checkout_pg_displays_handling_charge() throws InterruptedException, AWTException {
		TC_327_Check_checkout_page_displays_handling_charge ob = new TC_327_Check_checkout_page_displays_handling_charge ();
		ob.clickoncollection();
		ob.displayhandlingcharge();
		Log.info("Checking checkout page displays handling charge");
	}
