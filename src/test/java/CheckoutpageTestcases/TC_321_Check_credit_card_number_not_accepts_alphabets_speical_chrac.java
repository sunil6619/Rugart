...
public class TC_321_Check_credit_card_number_not_accepts_alphabets_speical_chrac extends Base{
	...
	public TC_321_Check_credit_card_number_not_accepts_alphabets_speical_chrac() {
	...
	public void check_creditcard_accept_16digits() throws InterruptedException, AWTException {
		TC_321_Check_credit_card_number_not_accepts_alphabets_speical_chrac ob = new TC_321_Check_credit_card_number_not_accepts_alphabets_speical_chrac();
		ob.clickoncollection();
		ob.entercreditcard();
		Log.info("Checking credit card not accept alphabets,special char");
	}
