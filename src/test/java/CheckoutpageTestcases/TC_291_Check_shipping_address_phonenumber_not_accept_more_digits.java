...
public class TC_291_Check_shipping_address_phonenumber_not_accept_more_digits extends Base{
	...
	public TC_291_Check_shipping_address_phonenumber_not_accept_more_digits() {
	...
	public void enterphonenumber() throws InterruptedException {
		...
		newaddress.click();
		Thread.sleep(3000);
		phonenumber.sendKeys("7011434499889");
		Thread.sleep(1000);	
		placeorder.click();
		Thread.sleep(1000);
	...
	public void check_phonenumber_not_accept_less_digits_verify_msg() throws InterruptedException, AWTException {
		TC_291_Check_shipping_address_phonenumber_not_accept_more_digits ob = new TC_291_Check_shipping_address_phonenumber_not_accept_more_digits();
		ob.clickoncollection();
		ob.enterphonenumber();
		Log.info("Checking shipping address phone number not accept more digits");
	}
