...
public class TC_302_Check_street_address_accept_alphanumeric extends Base{
	...
	TC_302_Check_street_address_accept_alphanumeric () {
	...
	public void enterstreetaddress() throws InterruptedException {
		...
		newaddress.click();
		Thread.sleep(2000);
		streetaddress.sendKeys("2546 New jersey");
		Thread.sleep(1000);
		String expected=streetaddress.getAttribute("value");
		Assert.assertEquals("2546 New jersey", expected);
	}
	

	@Test

	public void check_street_address_accept_alphanumeric() throws InterruptedException, AWTException {
		TC_302_Check_street_address_accept_alphanumeric ob = new TC_302_Check_street_address_accept_alphanumeric ();
		ob.clickoncollection();
		ob.enterstreetaddress();
		Log.info("Checking street address accept alphanumeric");
	}
