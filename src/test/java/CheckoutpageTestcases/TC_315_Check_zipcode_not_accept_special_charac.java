...
public class TC_315_Check_zipcode_not_accept_special_charac extends Base{
	...
	@FindBy(xpath = "//label[@for=\"shipping[postcode]\"]")
	private WebElement validationmsg;
	
	public TC_315_Check_zipcode_not_accept_special_charac() {
	...
	public void enterzipcode() throws InterruptedException {
		...
		Assert.assertEquals("Please enter only alphanumeric characters",expected);
	...
	public void check_zipcode_not_accept_special_charac() throws InterruptedException, AWTException {
		TC_315_Check_zipcode_not_accept_special_charac ob = new TC_315_Check_zipcode_not_accept_special_charac();
