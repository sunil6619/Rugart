...
public class TC_314_Check_zipcode_accept_upto_10chara extends Base{
	...
	public TC_314_Check_zipcode_accept_upto_10chara () {
	...
	public void enterzipcode() throws InterruptedException {
		...
		newaddress.click();
		Thread.sleep(1000);
		zipcode.sendKeys("12456798901");
		placeorder.click();
		String expected=validationmsg.getText();
		Assert.assertEquals("\"Postcode\" cannot be longer than 10 characters",expected);
	...
	public void check_zipcode_accept_upto_10chara_verify_msg() throws InterruptedException, AWTException {
		TC_314_Check_zipcode_accept_upto_10chara ob = new TC_314_Check_zipcode_accept_upto_10chara();
		ob.clickoncollection();
		ob.enterzipcode();
		Log.info("Checking zip code accept upto 10 char");
	}
