...
public class TC_317_Check_zipcode_displays_msg_left_blank extends Base{
	...
	public TC_317_Check_zipcode_displays_msg_left_blank() {
	...
	public void enterzipcode() throws InterruptedException {
		...
		Assert.assertEquals("The ZIP Code field is required",expected);
	...
	public void check_zipcode_not_display_left_blank() throws InterruptedException, AWTException {
		TC_317_Check_zipcode_displays_msg_left_blank ob = new TC_317_Check_zipcode_displays_msg_left_blank();
		ob.clickoncollection();
		ob.enterzipcode();
		Log.info("Checking zip code not display msg when left blank");
	}
