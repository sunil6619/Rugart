...
public class TC_318_Check_credit_card_number_displays_msg_left_blank extends Base{
	...
	public TC_318_Check_credit_card_number_displays_msg_left_blank() {
	...
	public void check_creditcard_left_blank_verify_msg() throws InterruptedException, AWTException {
		TC_318_Check_credit_card_number_displays_msg_left_blank ob = new TC_318_Check_credit_card_number_displays_msg_left_blank();
		ob.clickoncollection();
		ob.entercreditcard();
		Log.info("Checking credit card displays msg when left blank");
	}
