...
public class TC_290_Check_shipping_address_phonenumber_not_accept_less_digits extends Base {
	...
	public TC_290_Check_shipping_address_phonenumber_not_accept_less_digits() {
	...
	public void check_phonenumber_not_accept_less_digits_verify_msg() throws InterruptedException, AWTException {
		TC_290_Check_shipping_address_phonenumber_not_accept_less_digits ob = new TC_290_Check_shipping_address_phonenumber_not_accept_less_digits();
		ob.clickoncollection();
		ob.enterphonenumber();
		Log.info("Checking shipping address phone number not accept less digits");
	}
