...
public class TC_275_Check_shipping_address_firstname_display_validation_msg_left_blank extends Base{
	...
	public TC_275_Check_shipping_address_firstname_display_validation_msg_left_blank() {
	...
	public void first_name_left_blank() throws InterruptedException {
		Thread.sleep(1000);
		pagedown();
		widthft.sendKeys("4");
		lgthft.sendKeys("6");
	...
	public void check_first_name_blank_msg_shipping_address() throws InterruptedException, AWTException {
		TC_275_Check_shipping_address_firstname_display_validation_msg_left_blank ob = new TC_275_Check_shipping_address_firstname_display_validation_msg_left_blank ();
		ob.clickoncollection();
		ob.first_name_left_blank();
		Log.info("Checking shipping address first name displays validation error");
	}
