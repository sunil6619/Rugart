...
public class TC_295_Check_shipping_address_company_name_accept_upto_30charc extends Base{
	...
	public TC_295_Check_shipping_address_company_name_accept_upto_30charc () {
	...
	public void entercompanyname() throws InterruptedException {
		...
		newaddress.click();
		Thread.sleep(2000);
		companyname.sendKeys("ertyoio124513265616616lkiopfgtr");
		Thread.sleep(1000);
		placeorder.click();
		String expectedmsg=validationmsg.getText();
		Assert.assertEquals("\"Company Name\" cannot be longer than 30 characters", expectedmsg);
	}
	@Test

	public void check_shipping_add_company_name_acceptupto_30charac_verify_msg() throws InterruptedException, AWTException {
		TC_295_Check_shipping_address_company_name_accept_upto_30charc ob = new TC_295_Check_shipping_address_company_name_accept_upto_30charc();
		ob.clickoncollection();
		ob.entercompanyname();
		Log.info("Checking shipping address comp name accept upto 30charac");
	}
