...
public class TC_330_Check_checkout_page_place_order_displayed extends Base{
	...
	public  TC_330_Check_checkout_page_place_order_displayed() {
	...
	public void placeorder() throws InterruptedException {
		...
		topcheckout.click();
		Thread.sleep(3000);
		Boolean expected=placeorder.isDisplayed();
	...
	public void checkout_pg_displays_place_order() throws InterruptedException, AWTException {
		TC_330_Check_checkout_page_place_order_displayed ob = new TC_330_Check_checkout_page_place_order_displayed ();
		ob.clickoncollection();
		ob.placeorder();
		Log.info("Checking checkout page place order displays");
	}
