...
public class TC_292_Check_shipping_address_phonenumber_accept_valid_number extends Base{
	...
	public TC_292_Check_shipping_address_phonenumber_accept_valid_number() {
	...
	public void enterphonenumber() throws InterruptedException {
		...
		newaddress.click();
		Thread.sleep(3000);
		phonenumber.sendKeys("7011434499");
		Thread.sleep(1000);	
	...
	public void check_phonenumber_accept_digits() throws InterruptedException, AWTException {
		TC_292_Check_shipping_address_phonenumber_accept_valid_number ob = new TC_292_Check_shipping_address_phonenumber_accept_valid_number();
		ob.clickoncollection();
		ob.enterphonenumber();
		Log.info("Checking shipping address phone number accept valid data");
	}
