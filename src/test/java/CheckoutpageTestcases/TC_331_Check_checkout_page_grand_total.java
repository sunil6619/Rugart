...
public class TC_331_Check_checkout_page_grand_total extends Base{
	...
	public  TC_331_Check_checkout_page_grand_total() {
	...
	public void checkboxsamebilling_shippingadd() throws InterruptedException {
		...
		Thread.sleep(1000);
		List<WebElement> customize=driver.findElements(By.xpath("//span[contains (text(),'Custom Sizes')]"));
		WebElement first=customize.get(3);
		first.click();
		widthft.clear();
		widthft.sendKeys("6");
		lgthft.clear();
	    ...
	    Assert.assertEquals("$2,592",expected);

	}
	
	@Test

	public void checkout_pg_grand_total() throws InterruptedException, AWTException {
		TC_331_Check_checkout_page_grand_total ob = new TC_331_Check_checkout_page_grand_total ();
		ob.clickoncollection();
		ob.checkboxsamebilling_shippingadd();
		Log.info("Checking checkout page grand total");
	}
