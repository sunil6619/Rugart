...
public class TC_316_Check_zipcode_accept_digits_alphanumeric extends Base{
	...
	public TC_316_Check_zipcode_accept_digits_alphanumeric() {
	...
	public void enterzipcode() throws InterruptedException {
		...
		Thread.sleep(1000);
		String expected=zipcode.getAttribute("value");
		Assert.assertEquals("20500",expected);
		zipcode.clear();
		zipcode.sendKeys("2045MHAS");
		expected=zipcode.getAttribute("value");
		Assert.assertEquals("2045MHAS",expected);
	...
	public void check_zipcode_not_accept_special_charac() throws InterruptedException, AWTException {
		TC_316_Check_zipcode_accept_digits_alphanumeric ob = new TC_316_Check_zipcode_accept_digits_alphanumeric();
		ob.clickoncollection();
		ob.enterzipcode();
		Log.info("Checking zip code not accept special charac");
	}
