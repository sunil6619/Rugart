...
public class TC_311_Check_city_not_accept_alphanumeric extends Base{
	...
	public TC_311_Check_city_not_accept_alphanumeric() {
	...
	public void entercity() throws InterruptedException {
		...
		newaddress.click();
		Thread.sleep(2000);
		city.sendKeys("21545lkkpij");
		placeorder.click();
		Thread.sleep(1000);
		String expected=errormsg.getText();
		
		Assert.assertEquals("Please enter only alphabet characters",expected);
		
	}
	
	@Test

	public void check_city_not_accept_alphanumeric() throws InterruptedException, AWTException {
		TC_311_Check_city_not_accept_alphanumeric ob = new TC_311_Check_city_not_accept_alphanumeric();
		ob.clickoncollection();
		ob.entercity();
		Log.info("Checking city not accept alphanumeric,veriy error msg");
	}
