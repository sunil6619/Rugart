...
public class TC_207_Check_pile_height_changes_pile_weight_also_changes extends Base{
	...
	public  TC_207_Check_pile_height_changes_pile_weight_also_changes() {
	...
	public void click_different_pile_height() throws InterruptedException {
		...
		Assert.assertEquals("4000 gsm",expectedpileweight);
		Thread.sleep(1000);
		pileheight2.click();
		Thread.sleep(2000);;
		...
		Thread.sleep(2000);
		expectedpileweight=pileweight.getText();
		Assert.assertEquals("5500 gsm",expectedpileweight);
		Thread.sleep(1000);
		pileheight1.click();
		Thread.sleep(2000);
		expectedpileweight=pileweight.getText();
