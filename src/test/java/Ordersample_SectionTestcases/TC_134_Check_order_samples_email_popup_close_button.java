...
public class TC_134_Check_order_samples_email_popup_close_button extends Base {
	@Parameters ("url")
	@BeforeTest
	...
	public void check_order_sample_email_popup_close_button_Test() throws InterruptedException, AWTException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		WebElement emailpopupclosebutton=driver.findElement(By.xpath("//div[@class=\"modal-content\"]/child::button[@class=\"close\"]"));
		emailpopupclosebutton.isDisplayed();
		Assert.assertTrue(true);
		emailpopupclosebutton.click();
