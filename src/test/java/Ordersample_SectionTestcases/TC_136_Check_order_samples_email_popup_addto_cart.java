...
public class TC_136_Check_order_samples_email_popup_addto_cart extends Base{
	@Parameters ("url")
	@BeforeTest
	...
	public void check_order_sample_email_popup_addto_cart_Test() throws InterruptedException, AWTException {
		Thread.sleep(1000);
		...
		loginbutton.click();
		Thread.sleep(2000);
		WebElement shoppingcart=driver.findElement(By.xpath("//img[@alt=\"shopping bag\"]"));
		shoppingcart.click();
		Thread.sleep(1000);
