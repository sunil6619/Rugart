...
public class TC_112_Check_Order_Color_box_rugsize_cm_if_left_blank extends Base {
	@Parameters ("url")
	@BeforeTest
	...
	public void check_order_color_rugsize_cm_blank_Test() throws InterruptedException, AWTException {
		Thread.sleep(2000);
		...
		ordersamples.click();
		Thread.sleep(2000);
		WebElement cms=driver.findElement(By.xpath("//div[@class=\"rug-size-box cs-rug-size-box\"]/descendant::label[text()='CM']"));
		cms.click();
