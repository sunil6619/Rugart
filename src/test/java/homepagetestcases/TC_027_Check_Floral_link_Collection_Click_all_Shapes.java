...
public class TC_027_Check_Floral_link_Collection_Click_all_Shapes extends Base {
//	@Parameters("url")
//	@BeforeTest
...
//	}
	...
	public void check_floral_link_in_collection_click_all_shapes_Test() throws InterruptedException {
		...
		mousehover(collec);
		Thread.sleep(1000);
		driver.findElement(By.xpath("//img[@alt=\"Floral\"]/ancestor::div[@class=\"collection-item\"]")).click();
		Thread.sleep(1000);
